...
const handleSubmit=async(e:FormEvent)=>{
 e.preventDefault();
 await (signIn(nationalNumber,password));
        ...
        <div className='flex items-center w-full h-full gap-5 px-5 py-5 shadow-2xl rounded-2xl sm:flex-row'>
          ...
          <div className='w-full p-[5rem] '>
            <form onSubmit={handleSubmit} className='flex flex-col gap-10'>
              <h1 className='text-[50px] text-[var(--main-color)] font-bold'>Sign In</h1>
              <div className='flex flex-col gap-4'>
              <input
              type="text" 
              className='flex items-center w-full px-4 py-3 bg-gray-100 outline-none rounded-xl'
              placeholder='Enter Your NationalNumber...'
              ...
              <Link href="/forgetpassword" className='text-[var(--secondary-color)]'>forget passowrd?</Link>
             </div>
